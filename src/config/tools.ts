...
export const toolsConfig: ToolCategory[] = [
  {
    ...
    tools: [
      ...
      { name: 'URL Encoder/Decoder', slug: 'url-encoder-decoder', description: 'Encode/decode URL components.', icon: Link, category: 'security', implemented: false },
      { name: 'User-Agent Parser', slug: 'user-agent-parser', description: 'Parse User-Agent strings.', icon: Fingerprint, category: 'security', implemented: false },
  ...
  },
  {
    ...
    tools: [
      ...
      { name: 'Lorem Ipsum Generator', slug: 'lorem-ipsum-generator', description: 'Generate placeholder text.', icon: MessageSquare, category: 'developer', implemented: false },
  ...
  },
  {
    ...
    id: 'general',
    tools: [
      { name: 'Number to Words', slug: 'number-to-words', description: 'Convert numbers to words.', icon: Replace, category: 'general', implemented: false },
  ...
  },
  {
    ...
    id: 'advanced',
    tools: [
      { name: 'Steganography Encoder', slug: 'steganography-encoder', description: 'Hide text within images.', icon: Eye, category: 'advanced', implemented: false },
      { name: 'Caesar Cipher', slug: 'caesar-cipher', description: 'Simple substitution cipher.', icon: Key, category: 'advanced', implemented: false },
