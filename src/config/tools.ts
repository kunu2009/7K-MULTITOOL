...
export const toolsConfig: ToolCategory[] = [
  ...
  },
  {
    ...
    tools: [
      ...
      { name: 'Color Picker', slug: 'color-picker', description: 'Pick colors and create palettes.', icon: Palette, category: 'developer', implemented: true },
      { name: 'REST API Tester', slug: 'api-tester', description: 'Send HTTP requests to APIs.', icon: Cloud, category: 'developer', implemented: true },
      ...
      { name: 'Data Format Converter', slug: 'data-converter', description: 'Convert between CSV, JSON, XML, etc.', icon: Shuffle, category: 'developer', implemented: true },
    ],
  },
  {
    ...
    tools: [
      ...
      { name: 'Stopwatch & Timer', slug: 'stopwatch', description: 'Online stopwatch and countdown timer.', icon: Timer, category: 'general', implemented: true },
      { name: 'Text Cleaner', slug: 'text-cleaner', description: 'Remove extra spaces and newlines.', icon: BookText, category: 'general', implemented: true },
      { name: 'Secure Notes', slug: 'secure-notes', description: 'Client-side encrypted notes.', icon: LockKeyhole, category: 'general', implemented: true },
      { name: 'Unit Converter', slug: 'unit-converter', description: 'Convert between various units.', icon: Scale, category: 'general', implemented: true },
      { name: 'GPA Calculator', slug: 'gpa-calculator', description: 'Calculate Grade Point Average.', icon: Percent, category: 'general', implemented: true },
      { name: 'Project Management', slug: 'project-management', description: 'Simple project management tool.', icon: ClipboardList, category: 'general', implemented: true },
      { name: 'Currency Converter', slug: 'currency-converter', description: 'Convert between currencies.', icon: CircleDollarSign, category: 'general', implemented: true },
      { name: 'Scientific Calculator', slug: 'scientific-calculator', description: 'Advanced scientific calculator.', icon: FlaskConical, category: 'general', implemented: true },
    ],
  },
  {
    name: 'Advanced Tools',
